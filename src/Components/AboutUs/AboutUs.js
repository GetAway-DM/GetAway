        ...
        <Container>
          <div className="about-us">
            ...
            <p>
              ...
              a team of four full stack developers from Devmountain. We are
              passionate about creating technologies that make life easier.
              Sharing that frame of mind, we have found a common mission in
              delivering an application that can help you search for your next
              vacation rental.
            </p>
          ...
          <div className="index-container1">
            <h3 className="pages-header" id="meet-team">
              {' '}
              Meet The Team!
            </h3>
            <br />
              ...
              <Col xs="12" md={{ size: 6, offset: 3 }}>
                ...
                <div className="roundPics">
                  ...
                  <p>
                    ...
                    first using a computer.I enjoy creating beautifully desinged
                    intuitive and funcitonal websites.
              ...
              <Col xs="12" md={{ size: 6, offset: 3 }}>
                ...
                <div className="roundPics">
                  ...
                  <p>
                    ...
                    play hard to heart. I enjoy coding websites that are helpful
                    and fun.
                  </p>
