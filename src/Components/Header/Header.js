          ...
          {this.props.authReducer.isLoggedIn === true ? (
            <>
              <div className="signinas">
                Signed in as {this.props.authReducer.user.first_name}{' '}
              ...
              <div>
                <ReactBootStrap.NavDropdown
                  ...
                  <ReactBootStrap.NavDropdown.Item
                    onClick={() => {
                      this.props.history.push(
                        `/account/${this.props.authReducer.user.user_id}`
                      )
                    }}>
                    Profile
                  </ReactBootStrap.NavDropdown.Item>
                  <ReactBootStrap.NavDropdown.Item
                    onClick={() => {
                      this.props.history.push(
                        `/reservations/${this.props.authReducer.user.user_id}`
                      )
                    }}>
                    My Reservations
                  </ReactBootStrap.NavDropdown.Item>
                  ...
                  <ReactBootStrap.NavDropdown.Item href="/createlisting">
                    Create a Listing
                  </ReactBootStrap.NavDropdown.Item>
                  <ReactBootStrap.NavDropdown.Item
                    onClick={() => {
                      this.props.history.push(
                        `/listings/${this.props.authReducer.user.user_id}`
                      )
                    }}>
                    My Listings
                  </ReactBootStrap.NavDropdown.Item>
